 ...
 */
routes.get('/register', validateRequest(RegisterUserRequest), async (req: Request, res: Response) => {
 ...
 * @returns {Error} 500 - Internal Server Error
 */
routes.post('/login', validateRequest(AuthenticateUserRequest), async (req: Request, res: Response) => {
